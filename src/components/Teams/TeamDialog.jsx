      ...
      <Dialog>
        ...
        <DialogContent>
          ...
          <form onSubmit={handlesubmit}>
            ...
            <button
              type="submit"
              className="flex-1 font-medium bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-purple-200 dark:hover:shadow-purple-800 text-white hover:text-white transition-all duration-500 hover:scale-105  px-5 py-2 mb-2 rounded-sm dark:bg-gray-800 mt-2"
            >
              Add
            </button>
          </form>
