              ...
              return (
                ...
                >
                  ...
                  <div className="mb-9 flex flex-col gap-[14px]">
                    <ul className="max-w-[300px] mx-auto space-y-3">
                  ...
                  {pack.price !== "Free" ? (
                    isCurrentPlan ? (
                      ...
                      <button className="overflow-hidden mt-auto w-full p-2 h-12 text-white border-none rounded-md text-xl font-bold cursor-not-allowed capitalize bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-purple-200 dark:hover:shadow-purple-800 dark:text-white">
                        Already purchased
                      </button>
