        ...
        <section className="container mx-auto">
            ...
            <div className="my-6 text-center">
                <h1 className="text-5xl ">
                    <span className="font-bold">Supercharge your teamwork.</span> Start free
                </h1>
                <p className="text-xl pt-5">Unlimited boards and workflows. No credit card needed</p>
                            ...
                            <div className="flex w-full mb-8  sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 " data-aos="fade-down">
                                ...
                                <div className="flex flex-grow flex-col p-6    sm:p-8  border-gray-400 border-[1px] rounded-3xl hover:shadow-2xl duration-500">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="pt-4 ">
                                            <span className="text-6xl font-extralight">$<span className="font-bold">0</span>
                                    ...
                                    <p >For individuals looking to keep track of their work
                            ...
                            <div className="flex w-full mb-8   sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0" data-aos="fade-up">
                                ...
                                <div className="flex flex-grow flex-col p-6    sm:p-8  border-gray-400 border-[1px] rounded-3xl hover:shadow-2xl duration-500">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="pt-4 ">
                                            <span className="text-6xl font-extralight">$<span className="font-bold">9</span>
                                                <span className="text-sm font-normal pl-1">/month</span>
                                            </span>
                                        </p>
                                    </div>

                                    <span className="mt-4 leading-relaxed text-gray-600 font-semibold">Total $27/ month<br /><span className="font-light">Billed annually</span>
                                    ...
                                    <h4 className="text-xl font-semibold my-4">Includes free, plus:</h4>
                            ...
                            <div className="flex w-full mb-8   sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0" data-aos="fade-down">
                                ...
                                <div className="flex flex-grow flex-col p-6    sm:p-8  border-gray-400 border-[1px] rounded-3xl hover:shadow-2xl duration-500">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="pt-4 ">
                                            <span className="text-6xl font-extralight">$<span className="font-bold">19</span>
                                                <span className="text-sm font-normal pl-1">/month</span>
                                            </span>
                                        </p>
                                    </div>

                                    <span className="mt-4 leading-relaxed text-gray-600 font-semibold">Total $57/ month<br /><span className="font-light">Billed annually</span>
