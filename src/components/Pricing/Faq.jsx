            ...
            <div className=" text-gray-800 ">
                <div className=" flex flex-col lg:justify-center  p-4 lg:w-[70%] mx-auto md:p-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <details className="w-full border border-gray-300 rounded-lg" data-aos="zoom-in-down">
                            <summary className="py-6 px-4 lg:text-2xl text-lg outline-none cursor-pointer focus:underline">How secure is monday.com?</summary>
                            <div className="px-6 text-lg opacity-80 pb-4 space-y-2">
                                <p>The security of our customer’s data is our top priority. We use advanced security measures to preserve the integrity and privacy of your data, and adhere to strict data protection laws. monday.com is built with internationally recognized security standards and protocols in place, such as ISO/IEC 27001 and ISO/IEC 27018, and we undergo annual security audits and assessments.</p>

                            </div>
                        </details>
                        <details className="w-full border border-gray-300 rounded-lg" data-aos="zoom-in-down">
                            <summary className="py-6 px-4 lg:text-2xl text-lg outline-none cursor-pointer focus:underline">How can I manage my billing?</summary>
                            <div className="px-6 text-lg opacity-80 pb-4 space-y-2">
                                <p>If you are an admin of your account, you can access your purchase history, invoices, payment details, plan type, and more.</p>
