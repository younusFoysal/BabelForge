        ...
        <div className="">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-[12px]">
            ...
            <div className="mb-1">
              ...
              <Input type="purl" {...register('purl', { required: true })} placeholder="Please enter your project URL" id="purl" />
            </div>
            ...
            <div className="mb-1">
              ...
              <Input type="pimg" {...register('pimg', { required: true })} placeholder="Please enter your project image URL" id="pimg" />
            </div>
