    ...
    <Dialog>
      <DialogTrigger asChild>
        <button
          ...
          className="overflow-hidden mt-auto w-full p-2 h-12 bg-black dark:bg-[#3e1878c2]  text-white  rounded-md text-xl font-bold cursor-pointer relative z-10 group"
        >
          ...
          <span className="absolute w-full h-32 -top-20 -left-2 bg-purple-600 rotate-12 transform scale-x-0 group-hover:scale-x-110 transition-transform group-hover:duration-1000 duration-500 origin-left"></span>
