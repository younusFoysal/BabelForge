          ...
          <table className="w-full">
                  ...
                  <th key={pack._id} className="w-1/4 min-w-[200px] px-5">
                    <div className="text-left py-4 h-[250px] flex flex-col justify-between">
                      ...
                      {pack.price !== 'Free' ? (
                        ...
                        <button
                          onClick={() => router.push(`${auth ? '/dashboard' : '/sign-up'}`)}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border-t  border-purple-700 dark:border-[#3e1878c2] px-7 py-5  ">
                  <p className="flex justify-center text-center">{packages[0]?.Diagrams ? trueSVG : falseSVG}</p>
                </td>
                <td className="border-t  border-purple-700 dark:border-[#3e1878c2] px-7 py-5  ">
                  <p className="flex justify-center text-center">{packages[1]?.Diagrams ? trueSVG : falseSVG}</p>
                </td>
                <td className="border-t  border-purple-700 dark:border-[#3e1878c2] px-7 py-5  ">
                  <p className="flex justify-center text-center">{packages[2]?.Diagrams ? trueSVG : falseSVG}</p>
                </td>
              </tr>
            </tbody>
          </table>
