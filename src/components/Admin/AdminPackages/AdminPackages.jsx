...
const AdminPackages = () => {
    ...
    const falseSVG = <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path
                    ...
                    <table className="table-auto">
                        ...
                        <thead>
                            <tr>
                                ...
                                {
                                    packages.map(pack => <th key={pack._id} className="w-1/4 min-w-[200px] px-5">
                                        <div className="mb-10 text-left">
                                            ...
                                            <h4 className="mb-4">
                                                <span
                                                    className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">${pack.price}</span>
