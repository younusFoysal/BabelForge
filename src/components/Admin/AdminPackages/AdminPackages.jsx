...
const AdminPackages = () => {
    return (
        <div>
            ...
            <div
                className="relative z-10 overflow-hidden rounded-sm border border-stroke bg-white p-11 shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        <tr>
                            ...
                            <th className="w-1/4 min-w-[200px] px-5">
                                <div className="mb-10 text-left">
                                    ...
                                    <h4 className="mb-4">
                                        <span
                                            className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$59</span>
                            ...
                            <span className="mb-3.5 block text-xl font-bold text-black dark:text-white">
                              Agency
                                    ...
                                    <h4 className="mb-4">
                                        <span
                                            className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$99</span>
                                        <span className="font-medium">Per Month</span>
                                    </h4>
                            ...
                            <span className="mb-3.5 block text-xl font-bold text-black dark:text-white">
                              Extended
                                    ...
                                    <h4 className="mb-4">
                                        <span
                                            className="text-[28px] font-bold text-black dark:text-white lg:text-[32px]">$149</span>
                                        <span className="font-medium">Per Month</span>
                                    </h4>
                                    <p className="mb-6 font-medium">
