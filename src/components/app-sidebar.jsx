...
export function AppSidebar({ ...props }) {
  ...
  const filteredNavMain = data.navMain
    .map(item => {
      if (item.title === 'Chat') {
        if (plan !== 'Premium') {
          const filteredChatItems = item.items.filter(chatItem => chatItem.title !== 'Meeting');
      ...
      if (item.title === 'Tools') {
        const filteredItems = item.items.filter(
          tool => (tool.title !== 'AI Assistant' && tool.title !== 'Canvas' && tool.title !== 'Diagrams') || plan === 'Premium'
        );
