        ...
        <div className='mt-12'>
            ...
            <div className='flex flex-col-reverse lg:flex-row justify-between items-center gap-7 lg:gap-16 mx-2 lg:px-10 mt-16'>
                ...
                <div className='w-full lg:w-1/2 space-y-3 lg:space-y-7'>
                    <CommonText text={"June 10th, 2021 marked the start of a new era for monday.com—we rang the opening bell and officially became a publicly traded company on Nasdaq."} fullWidth="1"></CommonText>
                    <CommonText text={"These days, we continue to fuel our growth by evolving into a multi-product company, providing people, teams, and companies powerful products to help turn their work visions into a reality."} text2={"We’re only just getting started."} fullWidth="1"></CommonText>
                </div>
            </div>
        </div>
    );
