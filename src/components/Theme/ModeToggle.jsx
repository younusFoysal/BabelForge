...
export function ModeToggle() {
  ...
  return (
    ...
    //       variant="outline"
    //       size="icon"
    //       className="border-none outline-none bg-transparent hover:bg-transparent hover:border-none"
    //     >
    ...
    //   </DropdownMenuTrigger>
    //   <DropdownMenuContent
    //     className="z-[1000] dark:bg-gray-800 dark:border-gray-700"
    //     align="end"
    //   >
    ...
    <div className="toggle-cont relative">
      <input
