...
const Note = () => {
    ...
    console.log("my notes all",uemail);
    ...
    console.log("my notes all",notes);
                        ...
                        <div>
                            {notes?.map((message, index) => (
                                <div
                                    ...
                                    className={`cursor-pointer border-b-[1px] hover:border-b-4 hover:border-[#3e1878c2]  p-4 shadow-sm hover:bg-slate-200 dark:hover:bg-[#200e3be2] transition-all flex flex-col justify-between h-full relative ${index === 0 ? 'rounded-t-3xl' : index === notes.length - 1 ? 'rounded-b-3xl' : ''
                                        }`}
                                >
                                ...
                                <div className="bg-white border dark:border-[#3e1878c2] dark:bg-[#181024] gray-700 shadow w-full rounded-full mb-6 px-2">
                                    <div className="grid grid-cols-2 px-4 py-2">
                                        <h3 className="text-base flex items-center gap-[4px]">
                                            <span><HiOutlineOfficeBuilding /></span>{selectedMessage?.category}
                                        </h3>
                                        <p>
