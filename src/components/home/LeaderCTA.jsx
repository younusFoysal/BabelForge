...
const LeaderCTA = () => {
  return (
    <div className="px-4">
      <div className="  bg-white/5 backdrop-blur-lg border-white/15 border-[1px] max-w-[1200px]   rounded-2xl p-[40px] md:p-[75px] items-center mx-auto mb-[90px] grid grid-cols-1 md:grid-cols-2 gap-12  duration-500 hover:scale-105 hover:shadow-2xl dark:border-gray-800">
