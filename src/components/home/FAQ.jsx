    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            'Yes, BabelForge supports drag-and-drop functionality, allowing you to organize tasks by workflow in the task board view.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            'BabelForge integrates with tools like AI assistant, Docs sharing, Notes, Group chat, Video conferencing and many more to enhance team collaboration.',
        },
        {
          question: 'How can I access all the tools?',
          answer:
            "Under the 'Tools' section you will find all the tools provided by the babelforge. But all the tools are not free, you need to be a premium user to access those tools.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            'BabelForge offers multiple subscription plans to suit various team sizes and needs, including a Basic, Standard and Premium tiers with additional features.',
        },
        {
          question: 'What payment methods are accepted?',
          answer:
            "BabelForge accepts major credit cards like MasterCard, Visa for monthly and annual subscriptions. Check the 'Payment' section for full details.",
        },
        {
          question: 'Is my payment information secure?',
          answer:
            'Yes, BabelForge follows standard  ways to protect your payment details, ensuring your information is kept secure and confidential.',
        },
      ],
    },
  ];
