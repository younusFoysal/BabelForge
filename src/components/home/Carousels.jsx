...
import subimage1 from '@/image/Home/carousel/sub_service.png';
      ...
      <Carousel>
        <CarouselContent>
          <CarouselItem>
            ...
            >
              <h2 className="font-semibold max-w-[150px] mb-2 text-3xl text-white">Engagement survey</h2>
              <Image className="max-h-[36px]" src={subimage1} alt="" height={600} width={400} />
              {/* Hover Item */}
              <div className="w-full pb-10 h-full opacity-0 hover:opacity-100 duration-500 top-0 left-0  rounded-xl absolute p-6 bg-[#000000cc]">
                <h4 className="text-[#c3c6d4] font-light text-[14px]">Engagement survey</h4>
