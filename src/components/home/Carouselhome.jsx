...
const CarouselHome = () => {
  ...
  return (
    <div className=" relative w-screen mx-auto pt-8">
      <h2 className="text-center mb-10 text-[24px] text-[#333] font-semibold dark:text-white">
      ...
      <div className="hidden md:block absolute z-20 left-0 top-0 h-full w-[200px] bg-gradient-to-l from-[#ffffff00] to-[#fff] dark:bg-gradient-to-l dark:from-[#0000] dark:to-[#000]"></div>
      <div className="hidden md:block absolute z-20 right-0 top-0 h-full w-[200px] bg-gradient-to-r from-[#ffffff00] to-[#fff] dark:from-[#0000] dark:to-[#000]"></div>
    </div>
  );
};
