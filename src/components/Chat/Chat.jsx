...
const Chat = () => {
  ...
  return (
    <div className="mb-24">
      ...
      <div
        id="messageSection"
        className="w-full sm:w-[80vw] lg:w-[60vw] mx-auto"
      >
