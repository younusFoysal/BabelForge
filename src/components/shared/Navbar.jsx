          ...
          <ul className="flex space-x-3 items-center justify-center">
            {NavbarItems.map(nav => (
              <Link href={nav.href} key={nav.href}>
                <li className={` min-w-[82px] text-center hover:text-purple-700 hover:font-bold${pathname === nav.href ? 'dark:text-purple-400 text-purple-700 font-bold dark:font-semibold' : ''}`}>{nav.title}</li>
              </Link>
            ))}
          </ul>
        </nav>
