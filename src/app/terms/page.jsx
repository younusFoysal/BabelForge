        ...
        <section className="lg:px-0 bg-white/5 pb-[70px]  px-4 pt-[100px]">
            <div className="container mx-auto py-8 px-4">
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                        If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:your-contact-email@example.com" className="text-blue-500 underline">babelforgeltd@gmail.com</a>.
                    </p>
                </section>
            </div>
        </section>
