...
const DocumentPage = ({ params }) => {
    ...
    return (
        <div>
            <div className='flex md:justify-evenly px-20 md:flex-row flex-col gap-2 my-5'>
            ...
            {isEditable && (
                <div className="flex gap-5 justify-end">
                    ...
                    <button disabled={buttonLoading} type="button" class="px-6 -py-1  capitalize bg-gradient-to-r from-blue-600 to-purple-600  rounded-md transition-all duration-500  hover:scale-105 flex gap-1 items-center group dark:bg-gray-50 text-white text-sm">
